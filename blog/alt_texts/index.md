...
**Version 1.** Erste Entwürfe basierend auf der Prompt-Struktur des Vorgängerprojekts. Wir haben uns dabei einen methodischen Trick erlaubt: Eine Person schrieb den Alt-Text, die andere skizzierte das Chart nur anhand des Textes.
...
**Version 3.** Interviews mit fünf sehbehinderten und blinden Personen. Sie haben unsere Texte angehört und in Interviews mit uns ausführlich Feedback gegeben. Daraus ergaben sich klare Präferenzen, die wir vorher nicht antizipiert hatten.
...
Eine einzelne Evaluationsmethode reicht für Alt-Texte nicht aus. Jede hat blinde Flecken: Menschen skalieren nicht gut, Embedding-Metriken erfassen keine Struktur, und LLMs als Bewerter (LLM-as-a-Judge) haben eigene systematische Verzerrungen. Wir haben deshalb drei komplementäre Perspektiven kombiniert.
...
<div style="display: flex; gap: 1em; align-items: center; margin-top: 2em;">
  <img src="assets/NZZ.png" alt="NZZ Logo" style="width: 25%;">
  <img src="assets/SBV.jpg" alt="SBV Logo" style="width: 25%;">
  <img src="assets/FHNW_HSI_DE.png" alt="FHNW Logo" style="width: 25%;">
</div>